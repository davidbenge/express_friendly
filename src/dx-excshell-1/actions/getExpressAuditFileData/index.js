/**
 * clearExpressAuditData
 *
 * clear the data from the express audit data file
 */
...
async function main (params) {
  ...
  const actionName = 'clearExpressAuditData'
  /*********
  ...
  try {
    ...
    let assetReportEngine = new AssetReportEngine('asset-report/',logger)
    let assetFileReport = await assetReportEngine.getAssetReportFileData()

    debuggerOutput(`${actionName}`)
    content.assetFileReport = assetFileReport
